...
class MainApp(QWidget):
    ...
    def __init__(self):
        ...
        self.platform.addItem(
            QIcon(resource_path("assets/google.png")),
            "Google"
        )

        self.platform.addItem(
            QIcon(resource_path("assets/chatgpt.png")),
            "ChatGPT"
        )

        self.platform.addItem(
            QIcon(resource_path("assets/copilot.png")),
            "Copilot"
        )

        self.platform.addItem(
            QIcon(resource_path("assets/gemini.png")),
            "Gemini"
        )
        ...
        self.mode.addItem(
            QIcon(resource_path("assets/rectangle.png")),
            "Rectangle"
        )

        self.mode.addItem(
            QIcon(resource_path("assets/pencil.png")),
            "Pencil"
        )
        ...
        self.start_btn = QPushButton(
            QIcon(resource_path("assets/capture.png")),
            " Start Selection"
        )

        self.start_btn.setIconSize(
            QSize(24, 24)
        )
